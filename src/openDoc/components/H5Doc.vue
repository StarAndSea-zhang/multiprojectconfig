  ...
  <a-layout class="box-layout-container">
    ...
    >
      ...
      <div class="md-toc" mdtype="toc">
        <p class="md-toc-content" role="list">
          <span role="listitem" class="md-toc-item md-toc-h2" data-ref="n223"
            ><a class="md-toc-inner" style="cursor: pointer;" href="#接入说明"
              >接入说明</a
            ></span
          ><span role="listitem" class="md-toc-item md-toc-h2" data-ref="n26"
            ><a
              class="md-toc-inner"
              style="cursor: pointer;"
              href="#gameboxjsdk使用步骤"
              >GameBoxJSDK使用步骤</a
            ></span
          ><span role="listitem" class="md-toc-item md-toc-h3" data-ref="n27"
            ><a class="md-toc-inner" style="cursor: pointer;" href="#接入准备"
              >接入准备</a
            ></span
          ><span role="listitem" class="md-toc-item md-toc-h3" data-ref="n42"
            ><a
              class="md-toc-inner"
              style="cursor: pointer;"
              href="#步骤二引入js文件"
              >步骤二:引入JS文件</a
            ></span
          ><span role="listitem" class="md-toc-item md-toc-h3" data-ref="n50"
            ><a
              class="md-toc-inner"
              style="cursor: pointer;"
              href="#es5使用ruanyo-jbox-es5-101js导入"
              >Es5使用ruanyo-jbox-es5-1.0.1.js导入</a
            ></span
          ><span role="listitem" class="md-toc-item md-toc-h3" data-ref="n57"
            ><a
              class="md-toc-inner"
              style="cursor: pointer;"
              href="#步骤三接口调用说明"
              >步骤三:接口调用说明</a
            ></span
          ><span role="listitem" class="md-toc-item md-toc-h4" data-ref="n60"
            ><a class="md-toc-inner" style="cursor: pointer;" href="#基础接口"
              >基础接口</a
            ></span
          ><span role="listitem" class="md-toc-item md-toc-h5" data-ref="n61"
            ><a
              class="md-toc-inner"
              style="cursor: pointer;"
              href="#1获取用户信息接口"
              >1获取用户信息接口</a
            ></span
          ><span role="listitem" class="md-toc-item md-toc-h5" data-ref="n102"
            ><a
              class="md-toc-inner"
              style="cursor: pointer;"
              href="#2平台支付接口"
              >2平台支付接口</a
            ></span
          ><span role="listitem" class="md-toc-item md-toc-h5" data-ref="n153"
            ><a
              class="md-toc-inner"
              style="cursor: pointer;"
              href="#3支付回调通知"
              >3支付回调通知</a
            ></span
          ><span role="listitem" class="md-toc-item md-toc-h4" data-ref="n214"
            ><a class="md-toc-inner" style="cursor: pointer;" href="#签名说明"
              >签名说明</a
            ></span
          >
        </p>
    ...
    <a-layout-content>
      <div id="write" class="is-node">
        <h1>
          <a name="游戏盒子h5接口文档" class="md-header-anchor"></a
          ><span>游戏盒子H5接口文档</span>
        </h1>
        <figure>
          <table>
            <thead>
            ...
            <tbody>
              <tr>
                ...
                <td><span>创建接口文档</span></td>
                <td><span>V1.0.0</span></td>
              </tr>
              <tr>
                <td><span>张宇</span></td>
                <td><span>2020-3-6</span></td>
                <td><span>添加了获取用户信息接口</span></td>
                <td><span>V1.0.1</span></td>
              </tr>
              <tr>
                <td><span>张宇</span></td>
                <td><span>2020-3-7</span></td>
                <td><span>提供es5版本的jsdk</span></td>
                <td><span>V1.0.2</span></td>
              </tr>
            </tbody>
          </table>
        </figure>
        ...
        <blockquote>
          <p>
            <span
              >游戏盒子是面向H5端游戏开发者提供的基于微信公众号内的网页开发工具。通过接入GameBoxJSDK,网页开发者可借助平台推广游戏,同时可通过微信公众号让用户体验游戏,完成支付等功能。</span
            >
            <span
              >此文档只面向应用网页端开发者介绍游戏盒子如何使用及相关注意事项。</span
            >
          </p>
        </blockquote>
        <h2>
          <a name="gameboxjsdk使用步骤" class="md-header-anchor"></a
          ><span>GameBoxJSDK使用步骤</span>
        </h2>
        <h3>
          <a name="接入准备" class="md-header-anchor"></a><span>接入准备</span>
        </h3>
        <blockquote>
        ...
        <h3>
          <a name="步骤二引入js文件" class="md-header-anchor"></a
          ><span>步骤二:引入JS文件</span>
        </h3>
        <blockquote>
          <p>
            <span
              >在需要调用JS接口的页面引入GameBoxJSDK的js文件(接入平台后提供)</span
            >
          </p>
        </blockquote>
        <p>
          <span>支持es5链接（正式环境）:</span
          ><a
            href="http://player.bbox.dx-dj.com/ruanyo-jbox-es5-1.0.1.js"
            target="_blank"
            class="url"
            >http://player.bbox.dx-dj.com/ruanyo-jbox-es5-1.0.1.js</a
          >
        </p>
        <p>
          <span>支持es5链接（测试环境）:</span
          ><a
            href="http://player.test.bbox.dx-dj.com/ruanyo-jbox-es5-1.0.1.js"
            target="_blank"
            class="url"
            >http://player.test.bbox.dx-dj.com/ruanyo-jbox-es5-1.0.1.js</a
          >
        </p>
        <p>
          <span>支持es6及以上链接（正式环境）:</span
          ><a
            href="http://player.bbox.dx-dj.com/ruanyo-jbox-1.0.1.js"
            target="_blank"
            class="url"
            >http://player.bbox.dx-dj.com/ruanyo-jbox-1.0.1.js</a
          >
        </p>
        <p>
          <span>支持es6及以上链接(测试环境):</span
          ><a
            href="http://player.test.bbox.dx-dj.com/ruanyo-jbox-1.0.1.js"
            target="_blank"
            class="url"
            >http://player.test.bbox.dx-dj.com/ruanyo-jbox-1.0.1.js</a
          >
        </p>
        <blockquote>
          <p>
            <span
              >Es6使用ruanyo-jbox-1.0.1.js进行导入,可结合async await
              获取回调参数</span
            >
          </p>
        </blockquote>
        ...
        <h3>
          <a
            name="es5使用ruanyo-jbox-es5-101js导入"
            class="md-header-anchor"
          ></a
          ><span>Es5使用ruanyo-jbox-es5-1.0.1.js导入</span>
        </h3>
        <pre
          spellcheck="false"
          class="md-fences md-end-block ty-contain-cm modeLoaded"
        ...
        <blockquote>
          <p><span>如果您还有不了解 的地方,可通过以下地址下载demo</span></p>
        </blockquote>
        <p>
          <a
            href="http://player.bbox.dx-dj.com/bboxjsdk-demo.zip"
            target="_blank"
            class="url"
            >http://player.bbox.dx-dj.com/bboxjsdk-demo.zip</a
          >
        </p>
        <h3>
          <a name="步骤三接口调用说明" class="md-header-anchor"></a
          ><span>步骤三:接口调用说明</span>
        </h3>
        <blockquote>
          <p>
            <span>在需要使用GameBoxJSDK引入文件后,通过GameBoxJSDK进行调用</span>
          </p>
        </blockquote>
        <h4>
          <a name="基础接口" class="md-header-anchor"></a><span>基础接口</span>
        </h4>
        <h5>
          <a name="1获取用户信息接口" class="md-header-anchor"></a
          ><span>1获取用户信息接口</span>
        </h5>
        <p><span>参数说明：</span></p>
        <figure>
        ...
        <blockquote>
          <p><span>es6 可搭配async 和 await使用 </span></p>
        </blockquote>
        <p><span>示例:</span></p>
        <pre
          spellcheck="false"
        ...
        <p>
          <strong><span>回调参数说明</span></strong>
        </p>
        <figure>
          <table>
            <thead>
            ...
            <tbody>
              <tr>
                <td><span>id</span></td>
                <td><span>用户id,作为账号的唯一标识</span></td>
              </tr>
              <tr>
              ...
              <tr>
                <td><span>isCert</span></td>
                <td><span>是否实名认证,1为已认证,0为未认证</span></td>
              </tr>
            </tbody>
          </table>
        </figure>
        <p><span>回调参数示例:</span></p>
        <pre
          spellcheck="false"
          class="md-fences md-end-block ty-contain-cm modeLoaded"
          lang=""
        ...
        <h5>
          <a name="2平台支付接口" class="md-header-anchor"></a
          ><span>2平台支付接口</span>
        </h5>
        <p>
        ...
        <figure>
          <table>
            ...
            <tbody>
              ...
              <tr>
                <td><span>out_trade_no</span></td>
                <td><span>订单号</span></td>
                <td><span>是</span></td>
                <td><span>String</span></td>
              </tr>
              <tr>
                <td><span>notify_url</span></td>
                <td>
                  <span
                    >异步接收支付结果通知的回调地址，通知url必须为外网可访问的url，不能携带参数</span
                  >
                </td>
                <td><span>是</span></td>
                <td><span>String</span></td>
        ...
        <p>
          <strong><span>es6示例:</span></strong>
        </p>
        <blockquote>
          <p><span>可搭配async 和 await使用</span></p>
        </blockquote>
        <pre
          spellcheck="false"
          class="md-fences md-end-block ty-contain-cm modeLoaded"
        ...
        <p>
          <strong><span>接口回调参数说明</span></strong>
        </p>
        <pre
          spellcheck="false"
          class="md-fences md-end-block ty-contain-cm modeLoaded"
        ...
        <h5>
          <a name="3支付回调通知" class="md-header-anchor"></a
          ><span>3支付回调通知</span>
        </h5>
        <blockquote>
          <p>
            <span
              >支付完成后，通过【平台支付接口】中提交的参数notify_url设置。会把相关支付结果及用户信息通过数据流的形式
              POST
              发送给接入方，接入方需要接收处理，并按文档规范返回应答。</span
            >
          </p>
        </blockquote>
        <blockquote>
          <p>
            <span>说明：</span>
            <span
              >同样的通知可能会多次发送。接入方必须能够正确处理重复的通知，后台通知交互时，如果平台收到商户的应答不符合规范或超时，平台会判定本次通知失败，重新发送通知，直到成功为止</span
            >
          </p>
        </blockquote>
        <p>
          <strong><span>入参</span></strong>
        </p>
        <p><span>格式 json</span></p>
        <figure>
          <table>
            <thead>
              <tr>
            ...
            <tbody>
              ...
              <tr>
                <td><span>payTime</span></td>
                <td><span>支付时需要显示的商品名称</span></td>
                <td>&nbsp;</td>
                <td><span>String</span></td>
              </tr>
              <tr>
        ...
        <p>
          <strong><span>返回（应答）参数</span></strong>
        </p>
        <p><span>格式 json</span></p>
        <figure>
          <table>
            ...
            <tbody>
              <tr>
                <td><span>return_code</span></td>
                <td>
                  <span>SUCCESS/FAIL SUCCESS表示接收通知成功并校验成功</span>
                </td>
                <td>&nbsp;</td>
                <td><span>String</span></td>
              </tr>
              <tr>
                <td><span>return_msg</span></td>
